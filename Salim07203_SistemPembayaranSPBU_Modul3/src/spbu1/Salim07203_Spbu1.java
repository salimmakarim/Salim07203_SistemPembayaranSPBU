...
import Salim07203_Entity.*;
import Salim07203_Model.*;
    ...
    public static void main(String[] args) {
        ...
        while(true){ 
            ...
            if(pilmenu == 1){
                ...
                if(bbm == 1){
                    Salim07203_PenjualanEntity penjualan = new Salim07203_PenjualanEntity();
                    penjualan.setPembeli(Spbu1.pembeli.getByIndex(pembeli-1));
                    penjualan.setBbm(new Salim07203_PertaliteEntity());
