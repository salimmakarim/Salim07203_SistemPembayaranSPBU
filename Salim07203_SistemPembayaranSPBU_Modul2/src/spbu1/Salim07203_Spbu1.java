...
public class Salim07203_Spbu1 {
    private static Salim07203_DataPembeli pembeli = new Salim07203_DataPembeli();
    private static Salim07203_Penjualan penjualan = new Salim07203_Penjualan();
        ...
        while(true){
            ...
            if(pilmenu == 1){
                ...
                if(pilsubmenu1 == 1){
                    ...
                    Salim07203_Pembeli pembeli = new Salim07203_Pembeli();
                    pembeli.setNama(nama);
                    pembeli.setPlatnomer(plat);

                    Salim07203_Spbu1.pembeli.add(pembeli);
                    ...
                    Salim07203_Spbu1.pembeli.update(pembeli, index-1);
                }else if(pilsubmenu1 == 3){
                    System.out.print("Masukkan nomor yang mau di hapus: ");
                    int index = input.nextInt();
                ...
                if(bbm == 1){
                    PenjualanEntity penjualan = new Salim07203_PenjualanEntity();
                    ...
                    Salim07203_Salim07203_Spbu1.penjualan.add(penjualan);
                }else if(bbm == 2){
                    ...
                    Salim07203_Spbu1.penjualan.add(penjualan);
                }

            }else if(pilmenu == 3){
                for(Salim07203_PenjualanEntity p : penjualan.getAll()){
                    System.out.println("=====================================");
